        ...
        Swal.fire({
            ...
            html: `
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="img" id="image" accept="image/*" required class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-gray-500">
                </div>
