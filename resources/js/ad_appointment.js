                    ...
                    Swal.fire({
                        ...
                        html: `
                            <div class="appointment-details">
                                <strong>ID:</strong> ${
                                    response.id || "No disponible"
                                } <br>
                                <strong>Fecha:</strong> ${
                                    response.date || "No disponible"
                                } <br>
                                <strong>Hora:</strong> ${
                                    response.hour || "No disponible"
                                } <br>
                                <strong>Modalidad:</strong> ${
                                    response.modo || "No disponible"
                                } <br>
                                <strong>Descripción:</strong> ${
                                    response.description || "No disponible"
                                } <br>
                                <strong>Paciente:</strong> ${
                                    response.patient_name || "No asignado"
                                } <br>
                                <strong>Categoría:</strong> ${
                                    response.category_name || "No disponible"
                                } <br>
                                <strong>Doctor:</strong> ${
                                    response.doctor_name || "No asignado"
                                } <br>
                                <br>
                            </div>
                        `,
            ...
            didOpen: async () => {
                try {
                    const response = await fetch(
                        `/categorias/${categoryId}/doctores`
                    );
