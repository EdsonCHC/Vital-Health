<header>
    <div class="min-h-screen flex font-sans">
        ...
        <div
            ...
            <a href="/records" class="hover:bg-green-500 rounded-full py-2 px-2 transition-colors duration-300">
            ...
            <a href="/staff" class="hover:bg-green-500 rounded-full py-2 px-2 transition-colors duration-300">
