...
<div id="chat-container" class="hidden fixed bottom-16 right-4 w-96">
    <div class="bg-white shadow-md rounded-lg max-w-lg w-full">
        <div class="p-4 border-b bg-vh-green text-white rounded-t-lg flex justify-between items-center">
            <p class="text-lg font-semibold">{{__('messages.es_231')}}</p>
        ...
        <div class="p-4 border-t flex">
            <input id="user-input" type="text" placeholder="{{__('messages.es_232')}}"
                class="w-full px-3 py-2 border rounded-l-md focus:outline-none focus:ring-2 focus:ring-vh-green"
                autocomplete="none">
            <button id="send-button"
                class="bg-vh-green text-white px-4 py-2 rounded-r-md hover:bg-vh-green transition duration-300">{{__('messages.es_233')}}</button>
        </div>
    </div>
</div>