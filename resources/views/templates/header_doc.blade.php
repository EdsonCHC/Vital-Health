        ...
        <div class="px-5">
            <ul class="space-y-8">
                    ...
                    <div class="flex flex-col space-y-4">
                        <div
                            ...
                            <a href="/doctor" class="w-full flex items-center">
                                <img class="h-8 w-8 mx-2" src="{{ asset('storage/svg/homee.svg') }}"
                                    type="image/svg+xml" />
                                <p>Inicio</p>
                            </a>
                        </div>
                        <div
                            ...
                            <a href="/files_doc" class="w-full flex items-center">
                                <img class="h-8 w-8 mx-2" src="{{ asset('storage/svg/paciente.svg') }}"
                                    type="image/svg+xml" />
                                <p>Expedientes</p>
                            </a>
                        </div>
                        <div
                            ...
                            <a href="/citas_doc" class="w-full flex items-center">
                                <img class="h-8 w-8 mx-2" src="{{ asset('storage/svg/cita.svg') }}"
                                    type="image/svg+xml" />
                                <p>Citas</p>
                            </a>
                        </div>
                        <div
                            ...
                            <a href="/medicine_doc" class="w-full flex items-center">
                                <img class="h-8 w-8 mx-2" src="{{ asset('storage/svg/medicine.svg') }}"
                                    type="image/svg+xml" />
                                <p>Medicina</p>
                            </a>
                        </div>
                        <div
                            ...
                            <a href="/program_doc" class="w-full flex items-center">
                                <img class="h-8 w-8 mx-2" src="{{ asset('storage/svg/calendar.svg') }}"
                                    type="image/svg+xml" />
                                <p>Programación</p>
                            </a>
                        </div>
                ...
                <div class="absolute bottom-0 left-0 right-0 mb-4 px-2">
                    <a href="#" id="log_out"
                        class="flex items-center justify-center mb-5 w-11/12 h-14 rounded transition duration-300 bg-vh-green hover:bg-vh-gray hover:text-black text-white tracking-widest">
...
<div
    ...
    <a href="/medicine_doc" class="hover:bg-green-500 rounded-full py-2 transition-colors duration-300">
        <img class="h-8 w-8 mx-2" src="{{ asset('storage/svg/medicine.svg') }}" alt="Servicio" />
    </a>
