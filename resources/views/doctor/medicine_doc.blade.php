            ...
            <div class="w-full max-w-6xl mx-auto h-auto my-4 lg:my-5 px-4 lg:px-16">
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        @if ($recetas->isEmpty())
                            <p class="text-center font-semibold text-sm lg:text-lg text-vh-green my-4">No hay recetas
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        @if ($medicinas->isEmpty())
                            <p class="text-center font-semibold text-sm lg:text-lg text-vh-green my-4">No hay medicinas
                                creadas.</p>
                        @else
                            @foreach ($medicinas as $medicina)
                                <div
                                    ...
                                    <div class="p-4 border-t border-gray-200 flex justify-end">
                                        <button
                                            class="deleteMedicine bg-red-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-red-600 transition-colors duration-300"
                                            data-id="{{ $medicina->id }}">
                                            Eliminar
                                        </button>
                                    </div>
