                        ...
                        <div class=" bg-green-160  p-4  rounded-xl">
                            <div class="flex">
                                <div class="w-autolg:flex  lg:m-1">
                                    <h3 class="font-bold text-2xl lg:text-3xl text-white lg:w-auto">Examenes de Sangre</h3>
                                </div>
                                <div class="w-1/2 px-4 lg:px-2 ">
                                    <img class=" lg:flex lg:justify-end lg:w-auto" src="{{asset('storage/svg/file.svg')}}" type="image/svg+xml" />
                                </div>
