...
<head>
    ...
    <title>Citas</title>
    @vite(['resources/css/app.css', 'resources/css/sweet.css', 'resources/js/citas.js', 'resources/js/doc_citas.js', 'resources/js/doc_examenes.js', 'resources/js/doc_appointment.js', 'resources/js/doctor.js','resources/js/hadware.js','resources/js/videollamada.js'])
            ...
            <div class="max-w-full mx-auto">
                ...
                <div id="cita-{{ $cita->id }}" data-cita-id="{{ $cita->id }}"
                    ...
                    <div class="flex-1 flex justify-around space-x-4">
                        <button class="ml-4" id="add-vitals">
                            <img src="{{ asset('storage/svg/favicon.png') }}" alt="add" class="w-8 h-8 rounded">
                        </button>
