        ...
        <div class="flex justify-between items-center w-4/6 mt-4">
            <div class="flex flex-col space-y-4">
                <div class="w-96 max-w-md h-100 bg-white opacity-80 rounded-lg shadow-xl p-4">
                    <h2 class="w-full h-10 p-1 text-center text-white font-semibold text-xl bg-green-700 rounded-t-lg">
                        Datos</h2>
            ...
            <!-- Segundo Bloque -->
            <div class="w-112 h-108 m-4 bg-white opacity-80 rounded-lg shadow-xl border-2 border-solid border-vh-green">
