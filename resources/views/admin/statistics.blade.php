...
<body class="w-full h-full bg-vh-alice-blue">
    ...
    <div class="hidden lg:flex flex-col justify-between items-center ml-40 mt-12">
        ...
        <div class="flex justify-between w-5/6 mt-4">
            <div class="w-80 max-w-80 h-44 m-4 bg-white opacity-80 rounded-lg shadow-xl">
            ...
            <div class="w-80 max-w-80 h-44 m-4 bg-white opacity-80 rounded-lg shadow-xl">
                <div class="flex justify-evenly mt-5">
                    <div class="flex justify-evenly mt-5">
                        ...
                        <div>
                            <img class="w-32 mb-6" src="{{ asset('storage/svg/file-icon-second-green.svg') }}"
                                alt="Inicio" />
                        </div>
                    </div>
                </div>
            ...
            <div class="flex-col justify-between mt-4">
                ...
                <div class="w-80 h-[400px] m-4 bg-white opacity-80 rounded-lg shadow-xl">
        ...
        <div class="lg:hidden flex justify-center items-center m-4">
            <div>
                ...
                <div class="flex-col w-full mt-4">
                    <div
                        class="w-80 h-36 m-4 bg-white opacity-80 rounded-lg shadow-xl border border-solid border-vh-green">
                        <div class="flex justify-evenly text-center">
                            ...
                            <div class="my-4">
                                <img class="w-20" src="{{ asset('storage/svg/doc-icon-green.svg') }}"
                                    alt="Inicio" />
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex justify-evenly text-center">
                            ...
                            <div>
                                <img class="w-32" src="{{ asset('storage/svg/file-icon-green.svg') }}"
                                    alt="Inicio" />
                            </div>
                        </div>
                    </div>
