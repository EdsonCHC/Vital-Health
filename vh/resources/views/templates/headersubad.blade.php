      ...
      <div class="sidebar flex flex-col flex-grow justify-center ">
        <div class="flex flex-col space-y-4">
          ...
          <div class="flex flex-grow items-center ml-14 h-14 rounded-l-3xl transition duration-300 hover:bg-white">
            <a href="#" class="flex items-center h-full w-full text-md font-bold text-white hover:text-black ">
          ...
          <div class="flex flex-grow items-center ml-14 h-14 rounded-l-3xl transition duration-300 hover:bg-white">
            <a href="#"
              ...
              <img class="h-8 w-8 mx-2" src="{{asset('storage/svg/doc-icon-black.svg')}}" alt="Inicio" />
          ...
          <div class="flex flex-grow items-center ml-14 h-14 rounded-l-3xl transition duration-300 hover:bg-white">
            <a href="#"
              class="flex items-center h-full w-full text-md font-bold text-white hover:text-black tracking-wider">
              <img class="h-8 w-8 mx-2" src="{{asset('storage/svg/staff-icon-black.svg')}}" alt="Inicio" />
