                    ...
                    <div class="flex-col p-4 h-auto  bg-white  rounded-xl shadow- mt-4 ">
                        <div class=" md:w-full w-full lg:items-end lg:justify-end">
                            <a href="/login" target="_self"
                                class="w-2/5 lg:text-sm text-sm p-2 lg:w-40 h-12 text-white font-semibold bg-vh-green  tracking-wide shadow-xl lg:my-2  lg:mx-4 rounded-xl hover:bg-white transition duration-300 hover:text-vh-green inline-block text-center content-center">
                                Nuevo Expediente </a>
                        </div>
                        ...
                        <div
                            class=" lg:p-2 p-2 lg:px-8 flex justify-around items-center my-5 mx-auto bg-green-200   rounded-md">
