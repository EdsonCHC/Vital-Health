...
<body class="w-full h-screen bg-gray-200">
    ...
    <div class="flex w-full">
        ...
        <div class="w-full h-full overflow-y-auto ">
            <div class=" my-4 mx-4 lg:mt-16 lg:-32">
                <div class="w-3/4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:mt-20 mt-4">
                    <div class="bg-green-800 p-0.5 lg:w-96 w-62 rounded-xl">
                        <div class="bg-green-200 p-4 lg:p-10 rounded-xl">
                            <h3 class="font-bold text-lg lg:text-2xl text-vh-green">Examenes de Sangre</h3>
                            <a href="/login" target="_self"
                                class="w-full lg:w-2/3 h-10 lg:h-8 text-white bg-vh-green text-base lg:text-lg tracking-wide shadow-xl mt-4 lg:mt-8 mx-auto lg:mx-2 rounded-full hover:bg-white transition duration-300 hover:text-vh-green inline-block text-center content-center">
                                Visualizar
                            </a>
                        </div>
                    </div>
