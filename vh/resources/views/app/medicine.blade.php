    ...
    <div class="w-full h-auto  flex">
        <div class="bg-cover w-full flex justify-center items-center">
            <div class="w-full bg-white lg:p-5 p-2 ">
                <div
                    class="w-12/12 mx-auto rounded-2xl bg-white lg:p-5 p-2 ">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 text-center px-2 mx-auto">
                        <article
                            class="bg-white  lg:p-6 p-3 mb-6 shadow transition duration-300 group lg:transform lg:hover:-translate-y-2 hover:shadow-2xl rounded-2xl cursor-pointer border">
                            ...
                            <h3 class="font-medium text-xl leading-8">
                                <a href=""
                                    class="block lg:relative group-hover:text-vh-green transition-colors duration-200 ">
