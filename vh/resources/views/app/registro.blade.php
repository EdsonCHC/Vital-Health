...
<body class="w-full h-screen p-2 flex flex-col bg-white lg:flex-row">
    <div class="flex flex-col w-full h-full lg:w-3/5 lg:order-2">
        <div class="flex flex-col items-center w-full h-full lg:justify-center">
            ...
            <form action="" class="w-4/5 lg:flex flex-col items-center">
                <input class="block w-full p-2 outline outline-1 outline-vh-green mb-4 lg:w-2/5 "type="text " placeholder="Nombres">
                <input class="block w-full p-2 outline outline-1 outline-vh-green mb-4 lg:w-2/5 "type="text" placeholder="Apellidos">
                ...
                <button class="w-full p-2 rounded-md bg-vh-green text-white font-bold  lg:w-2/5">Ingresar</button>
            </form>
        </div>
