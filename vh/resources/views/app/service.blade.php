    ...
    <div class="flex justify-center items-center">
      <div class="w-auto flex flex-col ml-40">
        ...
        <div class="my-7 w-3/5">
          <p class="text-xl text-justify mb-4 font-bold text-gray-400 mx-4 -mt-1">
      ...
      <div class="flex justify-center items-center h-64 w-auto">
        <div class="ml-auto lg:ml-auto">
          <div class="">
            <img class="w-96 absolute z-10 -mt-52" src="{{asset('storage/svg/doctor.svg')}}" type="image/svg+xml" />
          </div>
        </div>
        <div class="ml-auto lg:ml-auto">
