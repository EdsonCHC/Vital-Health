    ...
    <body class="w-full h-full">
            ...
            <div class="flex justify-center items-center">
                <div class="w-auto flex flex-col ml-40">
                    <span class="font-bold text-4xl mb-2"
                        >Area de Cardiologia</span
                    >
                    <span class="font-bold text-4xl mb-4"
                        >Justo a tu Alcanze!!</span
                    >
                    <span class="font-bold text-2xl"
                        >Administración de Area designada</span
                    >
                    <div class="my-6 w-3/5">
                        <p
                            class="text-xl text-justify mb-4 font-bold text-gray-400"
                        >
                ...
                <div class="flex justify-center items-center w-auto">
                    <div class="ml-auto lg:ml-auto">
                        <div class="">
                            <img
                                class="w-96 absolute z-10 -mt-52"
                                src="{{asset('storage/svg/doctor.svg')}}"
                                type="image/svg+xml"
                            />
                        </div>
                    </div>
                    <div class="ml-auto lg:ml-auto">
                        <div
                            class="bg-vh-green-light opacity-60 rounded-full h-96 w-96 -mt-10"
                        >
        ...
        <div class="lg:hidden flex">
            ...
            <div class="ml-auto mt-12 lg:ml-auto">
                <div
                    class="bg-vh-green-light opacity-60 rounded-full h-60 w-60"
                >
                    <span class="invisible">a</span>
                </div>
            </div>
        ...
        <div class="lg:hidden flex justify-center items-center">
            <div class="w-64">
                ...
                <div class="my-5">
                    <p
                        class="text-xs text-justify mb-4 font-bold text-gray-400 mx-4 -mt-1"
                    >
                        Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry.
                    </p>
        ...
        <div class="flex justify-center text-center flex-col items-center">
            <div class="w-full h-auto">
                ...
                <div
                    class="w-full flex grow-0 flex-wrap items-center justify-center mb-8"
                >
                    <div
                        class="w-full min-w-40 max-w-72 mx-4 border border-solid border-vh-green py-4 my-4"
                    >
                        <h2 class="text-lg font-bold mb-2">Citas</h2>
                        <p
                            class="text-sm font-bold text-gray-400 mt-2 px-6 text-justify"
                        >
                        ...
                        <div class="flex flex-col px-8">
                            <label class="flex items-center">
                                <input
                                    type="checkbox"
                                    class="form-checkbox h-4 w-4 checkbox-custom"
                                />
            ...
            >
                ...
                <div class="flex justify-between w-4/6 mt-4 mx-">
                    <div
                        class="w-80 max-w-80 m-4 bg-vh-green-light opacity-80 rounded-xl flex"
                    >
                        <div class="mt-8 lg:ml-auto">
                            <div
                                class="bg-vh-green-medium rounded-full h-16 w-16"
                            >
                                <span class="invisible">a</span>
                            </div>
                        </div>
                        <div class="flex flex-col pl-4 mt-5 mx-auto">
                            ...
                            >
                                <div
                                    class="bg-vh-green-medium rounded-full h-10 w-10"
                                >
                                    <span class="invisible">a</span>
                                </div>
                                <div
            ...
            <div class="lg:hidden w-full text-center mb-8">
                ...
                <div
                    class="w-full h-auto flex flex-wrap items-center justify-center mt-4"
                >
                    <div
                        class="w-80 max-w-72 my-4 bg-vh-green-light opacity-80 rounded-xl flex"
                    >
                        <div class="ml-8 mt-8 lg:ml-auto">
                            <div
                                class="bg-vh-green-medium rounded-full h-16 w-16"
