    ...
    <div class="hidden lg:flex lg:pt-28 mb-5 w-full bg-gray-100">
      <div class="flex justify-center items-center">
        <div class="w-auto flex flex-col ml-40">
          ...
          >
          <div class="my-7 w-3/5">
            <p
              class="text-xl text-justify mb-4 font-bold text-gray-400 mx-4 -mt-1"
            >
        ...
        <div class="flex justify-center items-center h-64 w-auto">
        ...
        >
          ...
          >
            ...
            <p class="text-sm font-bold text-gray-400 mt-2 px-6 text-justify">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut ex id
              exercitationem amet unde aliquam, nihil, assumenda libero, atque
              veritatis pariatur nesciunt ipsam voluptatum blanditiis iure est
              dolor laudantium. Facere.
            </p>
            <hr class="mx-6 my-2" />
