...
<body class="bg-gray-100">
    ...
    <div class="grid grid-flow-col max-h-screen max-w-screen overflow-auto justify-center gap-5 mt-28 "><!--Div padre-->
        <!-- inicio apartado de todo los contactos-->
        <div class="mx-auto h-118 overflow-scroll  border rounded-lg row-span-3 bg-white-not-white">
            <div class="">
                    ...
                    <div class="max-w-lg w-full lg:max-w-xs">
                        ...
                        <form methode="get" action="#" class="relative z-50">
                            ...
                            <input type="text" name="s" id="s"
                                class="block w-full pl-10 pr-3 py-2 border border-transparent rounded-md leading-5 bg-gray-200 text-gray-300 placeholder-gray-400 focus:outline-none focus:bg-white focus:text-gray-900 sm:text-sm transition duration-150 ease-in-out"
        ...
        <!--Inicio del chat-->
        <div id="tres"
            class=" shadow-md h-118 w-128 overflow-scroll border rounded-lg row-span-2 mr-32 border-b bg-white-not-white">
            ...
            <div class="flex relative  items-center p-4 border-t">
                    ...
                    <svg width="28" height="21" viewBox="0 0 28 21" fill="none"
                        ...
                        <defs>
                            <clipPath id="clip0_124_2486">
                                <rect width="27.4625" height="19.9671" fill="white"
                                    transform="translate(0.217285 0.889648)" />
                            </clipPath>
                        </defs>
                    </svg>
